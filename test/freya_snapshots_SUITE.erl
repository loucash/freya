...
init_per_suite(Config) ->
    ...
    application:set_env(freya, w, 1),
    application:set_env(freya, dispatch_interval, 100),
    application:set_env(freya, snapshot_interval, 0),
    application:set_env(freya, max_aggregation_delay, 0),
    application:set_env(freya, edge_latency, 0),
    ok = freya:start(),
